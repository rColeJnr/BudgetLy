object Modules {
    ...
    const val options_overview = ":options:overview"

    const val options_settings = ":options:settings"

    const val options_categories = ":options:categories"
    const val options_categories_data = ":options:categories:data-categories"
    const val options_categories_screen = ":options:categories:screen-categories"

    const val options_transaction = ":options:transactions"
